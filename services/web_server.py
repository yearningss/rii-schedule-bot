...
async def get_latest_app_version_data(platform: str = "android") -> dict:
    ...
    return {
        ...
        "latest_build": 15,
        "download_url": f"https://github.com/yearningss/rii-schedule-bot/releases/download/v1.0.14/{target_ext}",
        "release_notes": "Обновление приложения и Telegram-бота РИИ (v1.0.14, сборка 15):\n- Полноценная система системных push-уведомлений о парах, переменах и начале занятий прямо на смартфоне\n- Добавлен высокоприоритетный канал уведомлений Android со всплывающими баннерами, звуком и вибрацией\n- В Настройки добавлена кнопка мгновенной проверки уведомлений (тестовое уведомление) и открытие системных параметров\n- В Telegram-бот добавлена кнопка и команда /download для прямой загрузки мобильного приложения на Android и iOS\n- В главное меню бота добавлена кнопка 'Скачать приложение'",
        "is_required": False
    }
