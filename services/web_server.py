...
async def get_latest_app_version_data(platform: str = "android") -> dict:
    ...
    return {
        ...
        "latest_build": 14,
        "download_url": f"https://github.com/yearningss/rii-schedule-bot/releases/download/v1.0.13/{target_ext}",
        "release_notes": "Обновление Telegram-бота и приложения РИИ (v1.0.13, сборка 14):\n- Исправлена ошибка обработки дней недели в Telegram-боте, восстановлена работа команд /today, /tomorrow и кнопок 'Сегодня', 'Завтра'\n- Восстановлена работа всех интерактивных inline-кнопок дней (Пн-Сб, переключение недели, обновление)\n- Добавлена новая команда /now ('Сейчас') с оперативным статусом текущей пары и перемены\n- Добавлены интерактивные кнопки навигации для недельного расписания\n- Добавлена поддержка русскоязычных команд и нечувствительность к регистру ввода\n- Добавлена кнопка отмены при смене группы и защита от сбоев удаления сообщений",
        "is_required": False
    }
